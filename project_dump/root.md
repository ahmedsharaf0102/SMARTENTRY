...
Real env files are skipped. Secrets are redacted.
...
## File: plan-tracker-and-dependencies.md
...
```bash
# ═══════════════════════════════════════
# SmartEntry Environment Variables
# ═══════════════════════════════════════
...
```json
{
  ...
  "exclude": ["node_modules", "telegram-bot", "analysis", "docker", "n8n"]
}
...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = ['/dashboard', '/signals', '/coin', '/profile'];
